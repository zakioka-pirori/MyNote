...
文系卒・現役エンジニアが、コンピュータサイエンスと高校数学を自習するための教科書群。

- **CS パート**: 学部卒相当の知識体系を 20 章で
- **高校数学パート**: 中学レベルから共通テスト 80 点以上を目指す 6 冊

📊 **[学習の記録](progress.md)** — 読んだ章にチェックを入れて、全体の進捗を確認できます。各章ページ上部の「読了にする」チェックと「メモ欄」も活用してください。
...
4. **わからない単語は飛ばさず、その場で調べる**。

スマホでは画面左上のメニューから章に飛べる。検索窓 (右上の虫眼鏡) で全章横断検索もできる。

## 章一覧

### カリキュラム概観
- [ロードマップ](cs-curriculum.md)
...
## 高校数学（共通テスト 80 点超えを目指す自習用）

中学数学だけで読める、書き下ろしの 6 冊。

- [はじめに](highschool-math/index.md)
- [数学 I](highschool-math/01-math-i.md) — 数と式、2 次関数、三角比、データ分析
- [数学 A](highschool-math/02-math-a.md) — 場合の数、確率、図形の性質、整数
- [数学 II](highschool-math/03-math-ii.md) — 式と証明、複素数、図形と方程式、三角・指数・対数、微積分入門
- [数学 B](highschool-math/04-math-b.md) — 数列、統計的な推測
- [数学 III](highschool-math/05-math-iii.md) — 極限、微分法、積分法（理系向け）
- [数学 C](highschool-math/06-math-c.md) — ベクトル、複素数平面、平面上の曲線
